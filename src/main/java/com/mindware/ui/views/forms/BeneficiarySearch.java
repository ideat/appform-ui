...
public class BeneficiarySearch extends Dialog {
    ...
    public Grid<GbageLabDto> gridGlobal;

    public BeneficiarySearch( Grid<GbageLabDto> grid){
        setDraggable(true);
        setModal(false);
        setResizable(true);
        ...
        // Header
        H2 title = new H2("Busqueda beneficiarios");
        ...
        content = new VerticalLayout(gridGlobal);
